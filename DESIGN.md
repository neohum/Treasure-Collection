# DESIGN.md — UI/UX system for Treasure-Collection
...
- **Favicon / logo:** derived from the Treasure-Collection identity and
...
If Treasure-Collection serves a web UI or ships as an app, this set exists before
